...
export const EXPLICIT_LANGUAGE_SWITCH: Record<DetectedLanguage, RegExp> = {
  ...
  hi: /hindi|हिंदी|हिन्दी|हिंदी\s+में|हिंदी\s+बोलो|हिंदी\s+बोलिए/i,
  mr: /marathi|मराठी|मराठीत|मराठी\s+बोला|मराठी\s+बोलो/i,
 ...
 * 2) Implicit: only switch when customer has ≥2 full consecutive turns in the other language.
 */
export function maybeSwitchLanguage(text: string, ctx: LanguageSwitchContext): void {
  ...
  // Priority 2: Implicit detection with 2-turn confidence
